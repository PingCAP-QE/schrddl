...
func (v *MutateVisitor) visitExprNode(in ast.ExprNode, flag int) {
	...
	case *ast.PatternLikeOrIlikeExpr:
		v.visitPatternLikeExpr(in.(*ast.PatternLikeOrIlikeExpr), flag)
...
func (v *MutateVisitor) visitPatternLikeExpr(in *ast.PatternLikeOrIlikeExpr, flag int) {
	if in == nil {
		return
	}
	if in.Not {
...
func (v *MutateVisitor) miningPatternLikeExpr(in *ast.PatternLikeOrIlikeExpr, flag int) {
	// RdMLikeU
