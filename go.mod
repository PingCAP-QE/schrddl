...
require (
	...
	github.com/pingcap/tidb v1.1.0-beta.0.20241012074155-025c2a3c5b72 // indirect
	github.com/pingcap/tidb/pkg/parser v0.0.0-20241011085547-a0bcee3366f6 // indirect
